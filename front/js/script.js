...
function card(sofa) {    // création des cartes produits
    ...
    img.src = sofa.imageUrl;  // on relie les propriétés des balises aux propriétés des produits
    img.alt = sofa.altTxt;
    h3.innerText = sofa.name;
    p.innerText = sofa.description;
    a.href = "./product.html?id=" + sofa._id;  //création des cibles des liens, en ajoutant l'ID de chaque produit
} 
